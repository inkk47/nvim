...
return {
  ...
  -- Rose pine Theme (Original)
  {
    "rose-pine/neovim", -- You can replace this with your favorite colorscheme
    lazy = false, -- We want the colorscheme to load immediately when starting Neovim
    name = "rosepine", -- name is needed otherwise plugin shows up as "nvim" due to github URI
    enabled = false,
    priority = 1000, -- Load the colorscheme before other non-lazy-loaded plugins
    config = function(_, opts)
  ...
  -- Gruv-box Material Theme
  {
    ...
    config = function()
      ...
      vim.cmd("colorscheme gruvbox-material") -- Replace this with your favorite colorscheme
    end,
  },
