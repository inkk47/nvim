return {
  ...
  config = function() -- This is the function that runs, AFTER loading
    ...
    require("which-key").add({
      ...
      { "<leader>p", group = "paste bellow", icon = { icon = " ", color = "red" } },
      { "<leader>P", group = "paste above", icon = { icon = " ", color = "red" } },
      { "<leader>W", group = "set wrap", icon = { icon = "󰖶 ", color = "grey" } },
      { "<leader>k", group = "kustomize", icon = { icon = "󱃾 ", color = "blue" } },
